...
train_path="../track3.edits"
valid_path="../yaclc-minimal_dev.edits"
config_path="./deepspeed_config.json"
timestamp=`date "+%Y%0m%0d_%T"`
save_dir="./ckpts/ckpt_$timestamp"
pretrained_transformer_path="../pretrain_model/chinese-roberta-wwm-ext-large"
mkdir $save_dir
cp $0 $save_dir
cp $config_path $save_dir
NCCL_DEBUG=INFO deepspeed --include localhost:0 --master_port 42997 train.py \
